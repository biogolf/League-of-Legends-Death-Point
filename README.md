...
### **เกี่ยวกับ League-of-Legends หรือ LoL**
 - League-of-Legends เป็นเกมออนไลน์ที่แข่งขันกันในรูป Moba โดยแบ่งเป็น 2 ฝ่าย ทั้งสองฝ่ายจะต้องใช้แชมเปี้ยน การต่อสู้จะเป็นไปในรูปแบบของประชันหน้ากันของตัวละครหลายๆคนในสนามประลอง ตัวเกมนั้นมีแบ่งระดับความเหมาะสมตามระดับของผู้เล่น โดยภายในตัวเกมประกอบไปด้วย Object ต่างๆ ดังนี้
...
![Alt text](./Image/Map.png)
 ...
 - **H ย่อมาจาก Inhibitor** คือ สิ่งก่อสร้างที่เมื่อถูกทำลายจะทำให้มินเนี่ยนของฝั่งตรงข้ามแข็งแกร่งขึ้น
 - **T ย่อมาจาก Turret** คือ ป้อมปราการที่ต้องทำลายตามลำดับ มีหน้าที่ป้องกันฝั่งตรงข้ามไปโจมตี Nexus 
 - **B ย่อมาจาก Baron** คือ สัตว์ในตำนานที่จะเสริมพลังความแข็งแกร่งให้มินเนี่ยนฝั่งที่กำจัดได้
 ...
 **โดยสรุปจากรูปกราฟที่เเสดงดังกล่าวในข้างต้น ในแต่ละLeague ได้ดังนี้ โดย 3 อันดับแรก ที่เล่นเกมยาวนานที่สุด ได้เเก่** <br>
 - 1. LCK , NALCS และ EULCS ► โดยเราจะเห็นได้ว่า leagueที่เวลาผ่านไป ยิ่งจะมีแนวโน้มที่เล่นนานขึ้นเรื่อยๆ ซึ่งต่างกับleague EULCS มีแนวโน้มใน เวลาเล่นที่คงที่ ตั้งแต่        ปี2015 ถึงปัจจุบัน<br>
