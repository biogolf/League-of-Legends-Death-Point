...
![Alt text](./Image/Map.png)
 ...
 ►► โดยสรุปจากรูปกราฟที่เเสดงดังกล่าวในข้างต้น ในแต่League ได้ดังนี้ โดย 3 อันดับแรก ที่เล่นเกมยาวนานที่สุด ได้เเก่/n
 1. LCK , NALCS และ EULCS ► โดยเราจะเห็นได้ว่า leagueที่เวลาผ่านไป ยิ่งจะมีแนวโน้มที่จะเล่นนานขึ้นเรื่อยๆ ซึ่งต่างกับleague EULCS มีแนวโน้มใน เวลาเล่นที่คงที่ ตั้งแต่        ปี2015 ถึงปัจจุบัน/n
 ...
 (CBLOL , OPL **หมายเหตุ** โดยสองleague ที่กล่าวนี้ ก่อนปี2015 ไม่มีในdatabase โดยได้เริ่มวิเคราะห์ตั้งแต่ปี2015เป็นต้น)/n
